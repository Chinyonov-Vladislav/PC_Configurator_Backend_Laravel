...
return new class extends Migration
{
    ...
    {
        Schema::create('compability_case_with_videocards', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId("compablity_with_videocard_type_id")->nullable()->references("id")->on("compablity_with_videocard_types")
